                    ...
                    <div className="bg-slate-900 p-6 rounded-[2.2rem] text-white relative overflow-hidden group shadow-xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex items-center justify-between mb-1">
                                <p className="text-3xl font-black tracking-widest font-mono select-all">1450213981</p>
                                <button
                                    onClick={() => handleCopy("1450213981", "No. Rekening")}
                            ...
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-tight mb-4">Bank BCA • A/N PT Lasak Sembilan Kreativa</p>
