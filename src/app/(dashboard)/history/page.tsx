              ...
              {isDetailLoading ? (
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between p-5 bg-linear-to-br from-blue-50 to-white rounded-2xl border border-blue-100 shadow-sm">
                        ...
                        <Badge className={cn(
                            "text-base px-6 py-2 h-auto rounded-xl shadow-sm",
                            selectedCheckup.globalStatus === "SEHAT" ? "bg-green-500 hover:bg-green-600" :
                            selectedCheckup.globalStatus === "WASPADA" ? "bg-yellow-500 hover:bg-yellow-600" : "bg-red-500 hover:bg-red-600"
                        )}>
