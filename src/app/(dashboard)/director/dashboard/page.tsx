...
import { 
  ...
  Building, ArrowUpRight, CheckCircle2, Search, X, Eye
} from "lucide-react";
import { cn } from "@/lib/utils";

// Mengimport Tipe Data
import { 
...
export default function DirectorDashboardPage() {
  ...
  // 1. Initial Data Fetching (Parallel Request)
  useEffect(() => {
    const initPage = async () => {
      // Cek sesi user di client side
      ...
      // Security Check: Hanya ROLE DIRECTOR
      ...
      try {
        ...
        console.error("Gagal memuat data dashboard direksi:", error);
      } finally {
        setIsLoading(false);
      }
    };
    ...
    <div className="min-h-full w-full pb-24">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10 -mt-20 relative z-20 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          {/* LEFT COLUMN: Unit Rankings & Search */}
