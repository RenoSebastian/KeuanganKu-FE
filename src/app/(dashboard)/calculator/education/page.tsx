      ...
      <div className="relative rounded-3xl bg-white border border-slate-200 p-6 md:p-10 overflow-hidden shadow-sm group">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Button 
            ...
            className="h-12 px-6 rounded-xl bg-brand-600 hover:bg-brand-700 text-white shadow-lg shadow-brand-600/20 font-bold transition-all hover:-translate-y-0.5 active:scale-95 w-full md:w-auto"
          >
