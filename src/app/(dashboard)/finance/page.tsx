  ...
  return (
    <Link href={item.href} className="group block h-full focus:outline-none">
      ...
      >
        ...
        <div
          className={cn(
            "w-16 h-16 md:w-20 md:h-20 rounded-xl md:rounded-2xl",
            "flex items-center justify-center text-3xl md:text-4xl border shadow-sm",
            "transition-transform duration-300",
            "group-hover:scale-105",
            item.style,
            "min-w-16 min-h-16" // Menambahkan ukuran minimal agar emoji tidak mengecil
          )}
        >
          {item.emoji}
        </div>
        ...
        {/* Text */}
        <div className="mt-2 md:mt-4 z-10 text-center">
